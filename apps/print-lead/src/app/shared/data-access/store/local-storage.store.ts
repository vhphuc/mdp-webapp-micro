...
export interface PrintLeadConfigKey {
...
export interface LocalStorageState {
  ...
  printLeadConfig: PrintLeadConfigKey | null;
...
export class LocalStorageStore extends ComponentStore<LocalStorageState> {
  ...
  onAppInit() {
    const initialState: LocalStorageState = {
      ...
      printLeadConfig: this.getPrintLeadConfig(),
  ...
  //region Print Lead Config

  printLeadConfigKey = 'print-lead-config';
  getPrintLeadConfig() {
    return lsGetKey<PrintLeadConfigKey>(this.printLeadConfigKey);
  }
  setPrintLeadConfig(value: {
    ...
    const notNullValue: PrintLeadConfigKey = {
      factory: value.factory!,
      station: value.station!,
      regularPrinter: value.regularPrinter!,
    };
    lsSetKey(this.printLeadConfigKey, notNullValue);
    this.patchState({ printLeadConfig: notNullValue });
  }
  removePrintLeadConfig() {
    lsRemoveKey(this.printLeadConfigKey);
    this.patchState({ printLeadConfig: null });
  }
