...
@Component({
  selector: 'app-image-details-polaris',
  standalone: true,
  templateUrl: './image-details-polaris.component.html',
  imports: [CommonModule, NzGridModule, NzModalModule, NzIconModule, NzButtonModule, TranslateModule],
  providers: [TranslatePipe],
})
export class ImageDetailsPolarisComponent {
  ...
  @Input() data!: PrintItemImageDetailApi.ImageDetailPolaris;
