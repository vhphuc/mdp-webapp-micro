...
@Component({
  selector: 'app-image-details-sticker',
  standalone: true,
  templateUrl: './image-details-sticker.component.html',
  imports: [CommonModule, NzGridModule, NzModalModule, NzIconModule, NzButtonModule, TranslateModule],
})
export class ImageDetailsStickerComponent {
  ...
  @Input() data!: PrintItemImageDetailApi.StickerInfoModel;
}
