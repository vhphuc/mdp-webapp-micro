...
@Component({
  selector: 'app-image-details-hat',
  standalone: true,
  templateUrl: './image-details-hat.component.html',
  imports: [CommonModule, NzGridModule, NzModalModule, NzIconModule, NzButtonModule, TranslateModule],
})
export class ImageDetailsHatComponent {
  ...
  @Input() data!: PrintItemImageDetailApi.HatInfoModel;
}
